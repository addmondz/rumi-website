...
function getColorScheme(scheme: "accent" | "blue" | undefined) {
  if (scheme === "blue") {
    return {
      check: "text-blue-500",
      ...
      finalCtaBg: "bg-gradient-to-br from-blue-600 to-blue-800 shadow-blue-600/20",
      finalCtaText: "text-blue-50",
      finalCtaBtn: "text-blue-700 hover:bg-blue-50",
      relatedLabel: "text-blue-700",
      relatedHover: "hover:border-blue-200",
      benefitsGradient:
        "linear-gradient(180deg, #eff6ff 0%, #f5f8ff 40%, #ffffff 100%)",
      faqGradient:
        "linear-gradient(180deg, #ffffff 0%, #f5f8ff 60%, #eff6ff 100%)",
    };
  }
  return {
    ...
    asideLabel: "text-accent-300",
    sectionLabel: "text-accent-700",
    badge: "bg-accent-100 text-accent-700",
    cardBorder: "border-l-accent-500",
    cardIconBg: "bg-accent-50",
    darkBadge: "bg-accent-500/10 text-accent-400 border-accent-500/20",
    darkLabel: "text-accent-400",
    finalCtaBg: "bg-gradient-to-br from-accent-500 to-accent-700 shadow-accent-500/20",
    finalCtaText: "text-accent-50",
    finalCtaBtn: "text-accent-700 hover:bg-accent-50",
    relatedLabel: "text-accent-700",
    relatedHover: "hover:border-accent-200",
    benefitsGradient:
...
function CheckIcon({ className }: { className?: string }) {
  return (
    <svg
      aria-hidden="true"
      className={`h-5 w-5 flex-shrink-0 ${className ?? "text-accent-500"}`}
      fill="none"
      viewBox="0 0 24 24"
      stroke="currentColor"
    >
...
export default function SeoLandingPage({ page }: { page: LandingPage }) {
  ...
  const c = getColorScheme(page.colorScheme);
  ...
  return (
    <main>
      ...
      <section className="relative overflow-hidden bg-navy-950 pt-28 text-white lg:pt-36">
        ...
        <div className="absolute top-10 right-[10%] w-[500px] h-[500px] rounded-full bg-blue-500/10 blur-[120px] z-[1] pointer-events-none" />
        <div className="absolute bottom-20 left-[5%] w-[300px] h-[300px] rounded-full bg-blue-400/[0.07] blur-[100px] z-[1] pointer-events-none" />
        ...
        <div className="relative z-10 mx-auto grid max-w-7xl gap-12 px-4 pb-20 pt-12 sm:px-6 lg:grid-cols-[1.1fr_0.9fr] lg:px-8 lg:pb-28">
          <div>
            <p className={`mb-5 inline-flex rounded-full bg-white/10 px-4 py-2 text-sm font-semibold ${c.eyebrow} ring-1 ring-white/15 backdrop-blur-sm`}>
              {page.hero.eyebrow}
            </p>
            ...
            <div className="mt-10 flex flex-col gap-4 sm:flex-row">
              <TrackedLink
                ...
                eventName="cta_click"
                eventParams={{ button: "hero_primary_cta", page: page.slug }}
                className={`group inline-flex items-center justify-center rounded-xl ${c.ctaGradient} px-7 py-4 text-base font-semibold text-white shadow-lg transition-all hover:-translate-y-0.5 hover:shadow-xl`}
              >
          ...
          <aside className="overflow-hidden rounded-2xl border border-white/[0.12] bg-white/[0.06] shadow-2xl shadow-black/20 backdrop-blur-md">
            ...
            <div className="p-6">
              <p className={`text-sm font-semibold uppercase tracking-wider ${c.asideLabel}`}>
                Page Focus
              </p>
      ...
      <section className="relative bg-white py-16 lg:py-24 overflow-hidden">
        ...
        <div className="relative mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-[0.8fr_1.2fr] lg:px-8">
          <div>
            <span className={`text-sm font-semibold uppercase tracking-wider ${c.sectionLabel}`}>
      ...
      <section
        ...
        style={{ background: c.benefitsGradient }}
      >
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <span className={`inline-block px-4 py-1.5 rounded-full ${c.badge} text-sm font-semibold mb-3`}>
              Benefits
            </span>
            <h2 className="mt-3 text-3xl font-bold tracking-tight text-navy-900 sm:text-4xl">
              {page.benefits.title}
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-3">
            {page.benefits.items.map((benefit) => (
              <article
                key={benefit.title}
                className={`rounded-2xl border border-gray-100 border-l-4 ${c.cardBorder} bg-white p-6 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300`}
              >
                <div className={`mb-5 flex h-11 w-11 items-center justify-center rounded-xl ${c.cardIconBg}`}>
                  <CheckIcon className={c.check} />
                </div>
      ...
      <section className="relative bg-navy-950 py-16 lg:py-24 overflow-hidden">
        ...
        <div className="absolute top-0 left-1/3 w-[600px] h-[300px] rounded-full bg-blue-500/[0.05] blur-[120px] pointer-events-none" />

        <div className="relative mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-2 lg:px-8">
          <div>
            <span className={`inline-block px-4 py-1.5 rounded-full ${c.darkBadge} text-sm font-semibold mb-3 border`}>
              Use Cases
            </span>
      ...
      >
        <div className="absolute bottom-0 right-0 w-[400px] h-[400px] rounded-full bg-blue-400/[0.04] blur-[120px] pointer-events-none" />

        <div className="relative mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-[1fr_0.9fr] lg:px-8">
          <div>
            <span className={`inline-block px-4 py-1.5 rounded-full bg-white/[0.06] ${c.darkLabel} text-sm font-semibold mb-3 border border-white/[0.08]`}>
              Trust
            </span>
            <h2 className="mt-3 text-3xl font-bold tracking-tight text-white sm:text-4xl">
              {page.trust.title}
      ...
      <section
        className="py-16 lg:py-24"
        style={{ background: c.faqGradient }}
      >
      ...
      <section className="bg-white py-16 lg:py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className={`rounded-2xl ${c.finalCtaBg} p-8 text-white shadow-xl lg:p-12`}>
            <div className="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-center">
              <div>
                <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">
                  {page.finalCta.title}
                </h2>
                <p className={`mt-4 max-w-3xl text-lg ${c.finalCtaText}`}>
                  {page.finalCta.body}
                </p>
              </div>
              <TrackedLink
                ...
                rel="noopener noreferrer"
                eventName="cta_click"
                eventParams={{ button: "final_cta_whatsapp", page: page.slug }}
                className={`inline-flex items-center justify-center rounded-xl bg-white px-7 py-4 text-base font-semibold ${c.finalCtaBtn} transition-all hover:-translate-y-0.5 shadow-lg`}
              >
      ...
      >
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl font-bold text-navy-900">
            More from Rumi Solutions
          </h2>
          <div className="mt-6 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            {relatedPages.map((related) => {
              const rc = getColorScheme(related.colorScheme);
              return (
                <Link
                  key={related.slug}
